...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-3">
      <InputGroup className="rounded-lg border-transparent bg-muted px-3">
...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        "overflow-hidden p-1.5 text-foreground **:[[cmdk-group-heading]]:mb-1 **:[[cmdk-group-heading]]:rounded-sm **:[[cmdk-group-heading]]:bg-orange-100 **:[[cmdk-group-heading]]:px-3 **:[[cmdk-group-heading]]:py-1.5 **:[[cmdk-group-heading]]:text-sm **:[[cmdk-group-heading]]:font-semibold **:[[cmdk-group-heading]]:tracking-wider **:[[cmdk-group-heading]]:text-foreground dark:**:[[cmdk-group-heading]]:bg-orange-400/40 dark:**:[[cmdk-group-heading]]:text-foreground/90",
        className
      )}
      {...props}
    />
