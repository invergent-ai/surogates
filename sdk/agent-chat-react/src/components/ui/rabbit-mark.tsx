...
export function RabbitMark({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="14.4021 11.93 95.1813 109.058"
      fill="currentColor"
      aria-hidden="true"
    >
      <path d={RABBIT_MARK_PATH} />
    </svg>
  );
}
