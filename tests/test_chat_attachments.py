"""Send-message attachment persistence, byte limits and injection protection.

The route resolves workspace paths, reads actual storage sizes, enforces budgets
and records accepted attachments in the user-message event."""
