...
- [ ] **In progress:** Task 2 - Add `InboxItem` ORM model and indexes.
- [ ] **Left to do:** Task 3 - Build inbox payload parser.
- [ ] **Left to do:** Task 4 - Extend `SessionStore.emit_event` to mirror inbox events.
