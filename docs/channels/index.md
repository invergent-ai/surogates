...
| **[Website](website.md)** | Public-website widget channel for anonymous visitors. Publishable-key auth, per-agent CORS, CSRF-protected cookie session, tool allow-list. |
