...
class AuditType(str, Enum):
    ...
    # per-agent MCP call.  Fires at the MCPCallSandbox
    # boundary so every tool invocation lands in the
    ...
    # per-tenant channel routing audit.  Fires at the
    ...
    # per-agent lifecycle audit.  AGENT_CREATED fires at
    # the create_agent service-layer boundary with the
    # admin's user_id who initiated the provision.  AGENT_DELETED
    # fires at delete_agent with the cascade outcome
