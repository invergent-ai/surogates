---
name: brainstorming_gate
description: Loaded with the skills guidance. Forces a brainstorming pass before any creative or implementation work begins.
applies_when: skill_view tool loaded
---
# Brainstorm before creating

Before any creative or implementation work — writing code, drafting a document, scaffolding a project, building a workflow, modifying behavior — you MUST load the `brainstorming` skill with `skill_view("brainstorming")` and complete its design loop with your human partner first.
