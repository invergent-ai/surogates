...
PACKAGE_DIR = pathlib.Path(__file__).parent.parent / "ecbench"
...
def test_package_importable():
    import ecbench  # noqa: F401


def test_ecsim_is_stdlib_only_at_import():
    """ecsim.py runs inside the sandbox before any pip install; its
    module-level imports must be pure standard library."""
    import ecbench.ecsim  # noqa: F401  (would raise on non-stdlib import)
