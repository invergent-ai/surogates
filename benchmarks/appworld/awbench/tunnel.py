...
1. ``AW_ADAPTER_PUBLIC_URL`` — a base URL you already operate
...
class Exposure:
    ...
    def restart(self, adapter_port: int) -> None:
        ...
        the operator supplied via ``AW_ADAPTER_PUBLIC_URL`` (we do
    ...
    *,
    ...
    if shutil.which("cloudflared") is None:
        raise TunnelError(
            ...
            "set AW_ADAPTER_PUBLIC_URL to a base URL that forwards "
