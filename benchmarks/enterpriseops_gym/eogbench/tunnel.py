...
1. ``EOG_ADAPTER_PUBLIC_URL`` — a base URL you already operate
...
class Exposure:
    ...
    def restart(self, adapter_port: int) -> None:
        ...
        the operator supplied via ``EOG_ADAPTER_PUBLIC_URL`` (we do
    ...
    *,
    ...
    if shutil.which("cloudflared") is None:
        raise TunnelError(
            ...
            "set EOG_ADAPTER_PUBLIC_URL to a base URL that forwards "
